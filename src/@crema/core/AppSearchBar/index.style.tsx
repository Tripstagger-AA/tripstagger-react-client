...
export const SearchWrapper = styled('div')(({position}: SearchWrapperProperties) => ({
  borderRadius: 4,
  display: 'block',
  cursor: 'pointer',
...
interface SearchIconBoxProperties {
  theme?: CremaTheme;
  align?: string;
...
export const SearchIconBox = styled('div')(({theme, align}: SearchIconBoxProperties) => ({
  position: 'relative',
