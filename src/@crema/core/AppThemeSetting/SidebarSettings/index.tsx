  ...
  return (
    <CustomizerItemWrapper>
      ...
      {isSidebarBgImage ? (
        ...
        >
          {sidebarBgImages.map(imagesObject => {
            return (
              <Box
                sx={{
                  display: 'flex',
              ...
              >
                <Box
                  ...
                  onClick={() => updateSidebarBgImage(imagesObject.id)}
                >
                  <img src={imagesObject.image} alt='nav' />
                  {sidebarBgImage === imagesObject.id ? (
                    <Box
                      sx={{
                        position: 'absolute',
                        left: '50%',
      ...
      <AppGrid
        ...
        column={2}
        itemPadding={5}
        renderRow={(colorSet, index) => <MenuColorCell key={index} sidebarColors={colorSet} />}
      />
    </CustomizerItemWrapper>
  );
};
