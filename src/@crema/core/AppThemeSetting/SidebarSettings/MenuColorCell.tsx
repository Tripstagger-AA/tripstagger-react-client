...
import {MenuStyle, NavStyle, ThemeMode} from '../../../../shared/constants/AppEnums';
...
interface MenuColorCellProperties {
  sidebarColors: SidebarData;
}

const MenuColorCell: React.FC<MenuColorCellProperties> = ({sidebarColors}) => {
  const {
    sidebarBgColor,
    sidebarTextColor,
