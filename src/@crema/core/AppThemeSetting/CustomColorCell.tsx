...
import {ThemeColorsProps as ThemeColorsProperties} from './ThemeColors';

interface CustomColorCellTypes {
  themeColorSet: ThemeColorsProperties;
  updateThemeColors: (colorSet: ThemeColorsProperties) => void;
}
