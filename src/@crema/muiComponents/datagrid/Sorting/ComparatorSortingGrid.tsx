...
const columns: GridColumns = [
  ...
  {field: 'age', type: 'number'},
  {
    ...
    valueGetter: (parameters: GridValueGetterParams) =>
      `${parameters.row.name || 'unknown'} - ${parameters.row.age || 'x'}`,
    sortComparator: (v1, v2, parameter1, parameter2) =>
      (parameter1.api.getCellValue(parameter1.id, 'age') as number) -
      (parameter2.api.getCellValue(parameter2.id, 'age') as number),
    width: 150,
  },
