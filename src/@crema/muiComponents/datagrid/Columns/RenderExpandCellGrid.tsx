...
interface GridCellExpandProperties {
  value: string;
  width: number;
}
...
const GridCellExpand = React.memo(function GridCellExpand(properties: GridCellExpandProperties) {
  const {width, value} = properties;
  ...
  const handleMouseEnter = () => {
    ...
    setAnchorElement(cellDiv.current);
  ...
  return (
    ...
    >
      ...
      {showPopper && (
        <Popper
          open={showFullCell && anchorElement !== null}
...
function renderCellExpand(parameters: GridRenderCellParams<string>) {
  return <GridCellExpand value={parameters.value || ''} width={parameters.colDef.computedWidth} />;
}
