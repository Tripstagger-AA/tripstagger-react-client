...
export default function ControlledSelectionServerPaginationGrid() {
  ...
  const previousSelectionModel = React.useRef<GridSelectionModel>(selectionModel);
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      setLoading(false);
      setTimeout(() => {
        setSelectionModel(previousSelectionModel.current);
      });
    })();
    ...
    <div style={{height: 400, width: '100%'}}>
      <DataGrid
        ...
        onPageChange={newPage => {
          previousSelectionModel.current = selectionModel;
          setPage(newPage);
        }}
