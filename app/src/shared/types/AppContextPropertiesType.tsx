import {
  ...
  ThemeMode,
  ThemeStyle,
} from '@app/constants/AppEnums';
import {LanguageProperties} from '@app/crema/core/AppLngSwitcher/data';
...
export default interface AppContextPropertiesType {
  theme: CremaTheme;
  routes: any;
  ...
  changeLocale: (locale: LanguageProperties) => void;
