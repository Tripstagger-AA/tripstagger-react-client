...
interface VerticalNavItemProperties {
  children: ReactNode;
  level: number;
  active: boolean;
...
const VerticalNavItem: React.FC<VerticalNavItemProperties> = ({
  children,
  active,
  level,
  ...rest
}) => {
  const {sidebarTextColor, sidebarMenuSelectedBgColor, sidebarMenuSelectedTextColor, menuStyle} =
    useSidebarContext();
