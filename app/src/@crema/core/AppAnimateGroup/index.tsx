...
interface AppAnimateGroupProperties {
  children: ReactNode;

  [x: string]: any;
}

const AppAnimateGroup: React.FC<AppAnimateGroupProperties> = properties => {
  return <div style={properties.style}>{properties.children}</div>;
};
