...
const CustomContent = React.forwardRef(function CustomContent(
  properties: TreeItemContentProps,
  reference,
) {
  const {
    classes,
  ...
  const icon = iconProperty || expansionIcon || displayIcon;
...
const CustomTreeItem = (properties: TreeItemProps) => (
  <TreeItem ContentComponent={CustomContent} {...properties} />
);
