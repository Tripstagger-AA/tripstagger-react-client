...
interface PopperComponentProperties {
  anchorEl?: any;
...
function PopperComponent(properties: PopperComponentProperties) {
  const {disablePortal, anchorEl, open, ...other} = properties;
...
export default function GitHubLabel() {
  ...
  return (
    <React.Fragment>
      ...
      <StyledPopper id={id} open={open} anchorEl={anchorElement} placement='bottom-start'>
