...
import ApiReferencePaginationGrid from './ApiRefPaginationGrid';
import ApiReferencePaginationGridSource from './ApiRefPaginationGrid';
      ...
      <AppGridContainer>
        ...
        <Grid item xs={12}>
          <AppComponentCard
            ...
            component={ApiReferencePaginationGrid}
            source={ApiReferencePaginationGridSource}
            noScrollbar
          />
        </Grid>
      </AppGridContainer>
