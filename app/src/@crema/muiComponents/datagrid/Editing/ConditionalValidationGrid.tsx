  ...
  const columns = [
    ...
    },
    {
      ...
      preProcessEditCellProps: parameters => {
        const editRowsModel = apiReference.current.getEditRowsModel();
        const isPaidProperties = editRowsModel[parameters.id].isPaid;
        const hasError = isPaidProperties.value && !parameters.props.value;
        return {...parameters.props, error: hasError};
      },
    },
  ];
