...
export default function VirtualElementPopper() {
  ...
  const [anchorElement, setAnchorElement] = React.useState<PopperProps['anchorEl']>(null);
  ...
  return (
    <div onMouseLeave={handleClose}>
      ...
      <Popper id={id} open={open} anchorEl={anchorElement} transition placement='bottom-start'>
        {({TransitionProps}) => (
